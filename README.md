...
Windows and macOS were manually verified in Clustta before extraction. Linux is experimental: native compilation and X11/Wayland desktop testing remain pending. Automated tests do not simulate user-driven OS drops. This checkout has not been published or tagged yet.
...
Until a release exists, use a sibling checkout and a temporary host-module replacement:
